...
function Invoke-Scenario {
    ...
    try {
        ...
        $env:INDUSPILOT_NOTIFICATIONS_WEBHOOK_ALLOWED_HOSTS = "127.0.0.1"
...
foreach ($name in @(
    ...
    "INDUSPILOT_NOTIFICATIONS_WEBHOOK_TIMEOUT_MS", "INDUSPILOT_NOTIFICATIONS_WEBHOOK_ALLOWED_HOSTS"
)) {
